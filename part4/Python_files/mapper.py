...
for line in sys.stdin:
    ...
    try:
        ...
        # print (moment)
        print '%d,%.3f,%.3f:%d' % (month,picklong,picklat,passengers)
        print '%d,%.3f,%.3f:%d' % (month,droplong,droplat,passengers)
    except:
        continue
